...
import os
if not os.path.exists("C:\\Users\\SATYA PRAKASH\\OneDrive\\Desktop\\Project\\graph_opt (1).pb"):
    print("Error: Model file not found at /content/graph_opt.pb")
    # Download or move the model file to the correct location
else:
    # Attempt to load the model
    try:
        net = cv2.dnn.readNetFromTensorflow("C:\\Users\\SATYA PRAKASH\\OneDrive\\Desktop\\Project\\graph_opt (1).pb")
...
# Example usage
input = cv2.imread('C:\\Users\\SATYA PRAKASH\\OneDrive\\Desktop\\Project\\IMG-20240805-WA0007.jpg')
